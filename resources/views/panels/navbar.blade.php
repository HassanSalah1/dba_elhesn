...
{{--                                                        class="fw-bolder">Congratulation Sam 🎉</span>winner!</p>--}}
...
{{--                        </li>--}}
          ...
          <span class="user-name fw-bolder">
            ...
            {{ Auth::user()->role }}
                                ...
                                <span class="avatar">
          <img class="round"
               src="{{ Auth::user() && Auth::user()->image !== null ? url(Auth::user()->image) : asset('images/portrait/small/avatar-s-11.jpg') }}"
