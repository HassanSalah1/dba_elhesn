                        ...
                        <form id="general-form">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="exampleFormControlTextarea1">
                                            {{trans('admin.'.\App\Entities\Key::TERMS_AR)}}
                                        </label>
                                        <textarea
                                            class="form-control" name="{{\App\Entities\Key::TERMS_AR}}"
                                            id="exampleFormControlTextarea1"
                                            rows="3"
                                            placeholder=" {{trans('admin.'.\App\Entities\Key::TERMS_AR)}}"
                                        >@if(isset($terms_ar) && $terms_ar){{$terms_ar->value}}@endif</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="exampleFormControlTextarea1">
                                            {{trans('admin.'.\App\Entities\Key::TERMS_EN)}}
                                        </label>
                                        <textarea
                                            class="form-control" name="{{\App\Entities\Key::TERMS_EN}}"
                                            id="exampleFormControlTextarea1"
                                            rows="3"
                                            placeholder=" {{trans('admin.'.\App\Entities\Key::TERMS_EN)}}"
                                        >@if(isset($terms_en) && $terms_en){{$terms_en->value}}@endif</textarea>
                                    </div>
                                </div>
    ...
    <script>
        $(function () {
            ...
            $('#general-form').submit(function (e) {
                e.preventDefault();
                console.log('test');
                sendAjaxRequest(this, '{{url('/admin/terms/save', [] , env('APP_ENV') === 'local' ?  false : true)}}', {
