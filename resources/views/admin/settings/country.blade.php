...
@section('page-script')
    ...
    <script>
        $(function () {
            ...
            loadDataTables('{{ url("/admin/countries/data", [] , env('APP_ENV') === 'local' ?  false : true)}}',
                ['name_ar', 'name_en', 'country_code', 'flag', 'actions'], '',
                {
        ...
        function changeCountryStatus(item) {
            ban(item, '{{url('/admin/country/change', [] , env('APP_ENV') === 'local' ?  false : true)}}', {
                error_message: '{{trans('admin.general_error_message')}}',
                error_title: '{{trans('admin.error_title')}}',
                ban_title: "{{trans('admin.change_action')}}",
                ban_message: "{{trans('admin.change_status_message')}}",
                inactivate: "{{trans('admin.change_action')}}",
