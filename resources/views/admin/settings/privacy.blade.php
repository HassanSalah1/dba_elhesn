                        ...
                        <form id="general-form">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="exampleFormControlTextarea1">
                                            {{trans('admin.'.\App\Entities\Key::PRIVACY_AR)}}
                                        </label>
                                        <textarea
                                            class="form-control" name="{{\App\Entities\Key::PRIVACY_AR}}"
                                            id="exampleFormControlTextarea1"
                                            rows="3"
                                            placeholder=" {{trans('admin.'.\App\Entities\Key::PRIVACY_AR)}}"
                                        >@if(isset($privacy_ar) && $privacy_ar){{$privacy_ar->value}}@endif</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="exampleFormControlTextarea1">
                                            {{trans('admin.'.\App\Entities\Key::PRIVACY_EN)}}
                                        </label>
                                        <textarea
                                            class="form-control" name="{{\App\Entities\Key::PRIVACY_EN}}"
                                            id="exampleFormControlTextarea1"
                                            rows="3"
                                            placeholder=" {{trans('admin.'.\App\Entities\Key::PRIVACY_EN)}}"
                                        >@if(isset($privacy_en) && $privacy_en){{$privacy_en->value}}@endif</textarea>
                                    </div>
                                </div>
    ...
    <script>
        $(function () {
            ...
            $('#general-form').submit(function (e) {
                e.preventDefault();
                console.log('test');
                sendAjaxRequest(this, '{{url('/admin/privacy/save', [] , env('APP_ENV') === 'local' ?  false : true)}}', {
