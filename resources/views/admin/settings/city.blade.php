...
@section('page-script')
    ...
    <script>
        $(function () {
            ...
            loadDataTables('{{ url("/admin/cities/data", [] , env('APP_ENV') === 'local' ?  false : true)}}',
        ...
        function deleteCity(item) {
            ban(item, '{{url('/admin/city/delete', [] , env('APP_ENV') === 'local' ?  false : true)}}', {
        ...
        function restoreCity(item) {
            ban(item, '{{url('/admin/city/restore', [] , env('APP_ENV') === 'local' ?  false : true)}}', {
                error_message: '{{trans('admin.general_error_message')}}',
                error_title: '{{trans('admin.error_title')}}',
