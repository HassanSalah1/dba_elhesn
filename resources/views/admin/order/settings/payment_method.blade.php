...
@section('page-script')
    ...
    <script>
        $(function () {
            ...
            loadDataTables('{{ url("/admin/payment_methods/data", [] , env('APP_ENV') === 'local' ?  false : true)}}',
        ...
        function deletePaymentMethod(item) {
            ban(item, '{{url('/admin/payment_method/delete', [] , env('APP_ENV') === 'local' ?  false : true)}}', {
        ...
        function restorePaymentMethod(item) {
            ban(item, '{{url('/admin/payment_method/restore', [] , env('APP_ENV') === 'local' ?  false : true)}}', {
                error_message: '{{trans('admin.general_error_message')}}',
                error_title: '{{trans('admin.error_title')}}',
