                            ...
                            <div class="col-md-12">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$order->damainOrder->name}}</td>
                                    </tr>
                                    <tr>
                                        <td>{{trans('admin.description')}}</td>
                                        <td>{{$order->damainOrder->description}}</td>
                                    </tr>
                                    <tr>
                                        <td>{{trans('admin.category_name')}}</td>
                                        <td>{{@$order->damainOrder->category->name}}</td>
                                    </tr>
                                    <tr>
                                        <td>{{trans('admin.sub_category_name')}}</td>
                                        <td>{{@$order->damainOrder->sub_category->name}}</td>
                                    </tr>
                                    <tr>
                                        <td>{{trans('admin.sub_sub_category_name')}}</td>
                                        <td>{{@$order->damainOrder->sub_sub_category->name}}</td>
                                    </tr>
                                    <tr>
                                        <td>{{trans('admin.price')}}</td>
                                        <td>
                                            {{$order->damainOrder->total_price.' '.trans('api.ryal')}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>{{trans('admin.address')}}</td>
                                        <td>
                                            {{$order->damainOrder->address}}
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
