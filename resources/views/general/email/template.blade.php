...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
      xmlns:o="urn:schemas-microsoft-com:office:office" @if($data['lang'] == 'ar') dir="rtl"
      @else dir="ltr"@endif>
<head>
    <!-- NAME: NOTEPAD - HORIZONTAL -->
    <!--[if gte mso 15]>
    <xml>
...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" background="#fff"
        ...
        <tr>
            <td valign="top" style="padding:9px"
                ...
                <table align="left" width="100%" border="0"
                       ...
                       style="min-width:100%;margin-bottom:  0px;">
                    <tbody>
                    <tr>
        ...
        <tr>
            <td align="center" valign="top">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                    <tr>
                        <td align="center" valign="top"
                            style="padding-top:15px; padding-right:5px; padding-bottom:0; padding-left:5px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="640"
                                   class="templateContainer">
                                <tr>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr style="padding: 0px;">
                                                            <td valign="top" class="mcnTextBlockInner"
                                                                ...
                                                                <table align="left" border="0"
                                                                       cellpadding="0" cellspacing="0"
                                                                       style="max-width:100%; min-width:100%; margin-bottom: 0px;"
                                                                       width="100%"
                                                                       class="mcnTextContentContainer">
                                                                    <tbody>
                                                                    <tr>
